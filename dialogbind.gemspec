...
Gem::Specification.new do |gemdesc|
	...
	gemdesc.summary = 'DialogBind provides a Ruby API that wraps around Linux and macOS message box-generating tools. As of version 0.9.2, Windows is also supported. See https://gitlab.com/timkoi/dialogbind/blob/master/README.md for documentation.'
